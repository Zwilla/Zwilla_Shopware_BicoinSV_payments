...
Ext.define('Shopware.apps.PaymentBitcoinSV.controller.Main', {
     ...
     * @param code
     */
    showBitcoinSVErrorMessage: function(title, error, code) {
        var me = this,
            message;
    ...
    onLoadDetail: function(records, operation, success) {
        ...
        if(!detail) {
            ...
            if (!success) {
                ...
                me.showBitcoinSVErrorMessage(me.snippets.error.title, error, errorCode);
            }
            return;
        }
        formPanel.setLoading(false);
